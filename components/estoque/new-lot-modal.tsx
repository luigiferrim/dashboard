  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-[#8B6F47] hover:bg-[#8B6F47]/90 text-sm md:text-base">Novo Lote</Button>
      </DialogTrigger>
      <DialogContent className="max-w-[95vw] md:max-w-2xl max-h-[85vh] md:max-h-[90vh] overflow-y-auto">
        <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-2 justify-end pt-4">
            ...
            <Button type="submit" disabled={loading} className="bg-[#8B6F47] hover:bg-[#8B6F47]/90 w-full sm:w-auto">
